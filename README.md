...
<b>However</b>,  If we have test data and want to make predictions, LDA is still a good to use. When using words2vec and kmeans, we can predict which cluster a word belong to.
