...
<b>Note</b> LDA is a type of clustering too. In my code, so far I think word2vec is more convenient because it keeps the origional words so that we can check whether the modeling results make sense. So far, I haven't found a way to convert the numbers generated by Spark HashingTF and Spark LDA into the original words....
